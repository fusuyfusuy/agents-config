...
function resolveAstGrep(cwd: string): string | null {
  ...
  const { findOnPath } = (() => {
    try {
      return require("/home/devhax/.nvm/versions/node/v24.16.0/lib/node_modules/@earendil-works/pi-coding-agent/dist/core/platform") as any;
    } catch {
      return { findOnPath: () => null };
    }
  })();
...
// tui-agent-settings/skills/agent-context/agent-ctx or pi-lens review-graph.
